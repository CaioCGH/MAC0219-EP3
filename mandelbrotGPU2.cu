...
__global__
 void GPUimage(float *buffer, int chunk_size, int y_0, int y_f, int width, int height, float a_0, float b_0, float a_1, float b_1, int maxIteration, int world_rank){
